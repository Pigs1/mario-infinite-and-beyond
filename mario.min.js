var Mario = {
    SpriteCuts: {
        CreateBlackFont: function () { return new Enjine.SpriteFont([], Enjine.Resources.Images.font, 8, 8, this.GetCharArray(0)) }, CreateRedFont: function () { return new Enjine.SpriteFont([], Enjine.Resources.Images.font, 8, 8, this.GetCharArray(8)) }, CreateGreenFont: function () { return new Enjine.SpriteFont([], Enjine.Resources.Images.font, 8, 8, this.GetCharArray(16)) }, CreateBlueFont: function () { return new Enjine.SpriteFont([], Enjine.Resources.Images.font, 8, 8, this.GetCharArray(24)) }, CreateYellowFont: function () {
            return new Enjine.SpriteFont([],
                Enjine.Resources.Images.font, 8, 8, this.GetCharArray(32))
        }, CreatePinkFont: function () { return new Enjine.SpriteFont([], Enjine.Resources.Images.font, 8, 8, this.GetCharArray(40)) }, CreateCyanFont: function () { return new Enjine.SpriteFont([], Enjine.Resources.Images.font, 8, 8, this.GetCharArray(48)) }, CreateWhiteFont: function () { return new Enjine.SpriteFont([], Enjine.Resources.Images.font, 8, 8, this.GetCharArray(56)) }, GetCharArray: function (a) { for (var b = [], c = 0, c = 32; c < 127; c++)b[c] = { X: (c - 32) * 8, Y: a }; return b }, GetBackgroundSheet: function () {
            for (var a =
                [], b = 0, c = 0, e = Enjine.Resources.Images.background.width / 32, d = Enjine.Resources.Images.background.height / 32, b = 0; b < e; b++) { a[b] = []; for (c = 0; c < d; c++)a[b][c] = { X: b * 32, Y: c * 32, Width: 32, Height: 32 } } return a
        }, GetLevelSheet: function () { for (var a = [], b = 0, c = 0, e = Enjine.Resources.Images.map.width / 16, d = Enjine.Resources.Images.map.height / 16, b = 0; b < e; b++) { a[b] = []; for (c = 0; c < d; c++)a[b][c] = { X: b * 16, Y: c * 16, Width: 16, Height: 16 } } return a }
    }, Tile: {
...
Mario.Level.prototype = {
    Update: function () { for (var a = 0, b = 0, a = 0; a < this.Width; a++)for (b = 0; b < this.Height; b++)this.Data[a][b] > 0 && this.Data[a][b]-- }, GetBlockCapped: function (a, b) { a < 0 && (a = 0); b < 0 && (b = 0); a >= this.Width && (a = this.Width - 1); b >= this.Height && (b = this.Height - 1); return this.Map[a][b] }, GetBlock: function (a, b) { a < 0 && (a = 0); if (b < 0) return 0; a >= this.Width && (a = this.Width - 1); b >= this.Height && (b = this.Height - 1); return this.Map[a][b] }, SetBlock: function (a, b, c) {
        a < 0 || b < 0 || a >= this.Width || b >= this.Height || (this.Map[a][b] =
            c)
    }, SetBlockData: function (a, b, c) { a < 0 || b < 0 || a >= this.Width || b >= this.Height || (this.Data[a][b] = c) }, IsBlocking: function (a, b, c, e) { a = this.GetBlock(a, b); b = (Mario.Tile.Behaviors[a & 255] & Mario.Tile.BlockAll) > 0; b |= e > 0 && (Mario.Tile.Behaviors[a & 255] & Mario.Tile.BlockUpper) > 0; b |= e < 0 && (Mario.Tile.Behaviors[a & 255] & Mario.Tile.BlockLower) > 0; return b }, GetSpriteTemplate: function (a, b) { if (a < 0) return null; if (b < 0) return null; if (a >= this.Width) return null; if (b >= this.Height) return null; return this.SpriteTemplates[a][b] }, SetSpriteTemplate: function (a,
        b, c) { a < 0 || b < 0 || a >= this.Width || b >= this.Height || (this.SpriteTemplates[a][b] = c) }
}; Mario.BackgroundGenerator = function (a, b, c, e) { this.Width = a; this.Height = b; this.Distant = c; this.Type = e };
Mario.BackgroundGenerator.prototype = {
    SetValues: function (a, b, c, e) { this.Width = a; this.Height = b; this.Distant = c; this.Type = e }, CreateLevel: function () { var a = new Mario.Level(this.Width, this.Height); switch (this.Type) { case Mario.LevelType.Overground: this.GenerateOverground(a); break; case Mario.LevelType.Underground: this.GenerateUnderground(a); break; case Mario.LevelType.Castle: this.GenerateCastle(a) }return a }, GenerateOverground: function (a) {
        for (var b = this.Distant ? 4 : 6, c = this.Distant ? 2 : 1, e = Math.floor(Math.random() *
            b) + c, d = Math.floor(Math.random() * b) + c, f = 0, g = 0, h = 0, i = 0, i = 2, f = 0; f < this.Width; f++) { for (e = d; e === d;)d = Math.floor(Math.random() * b) + c; for (g = 0; g < this.Height; g++)h = e < d ? e : d, i = e < d ? d : e, g < h ? this.Distant ? (i = 2, g < 2 && (i = g), a.SetBlock(f, g, 4 + i * 8)) : a.SetBlock(f, g, 5) : g === h ? (i = h === d ? 0 : 1, i += this.Distant ? 2 : 0, a.SetBlock(f, g, i)) : g === i ? (i = h === d ? 0 : 1, i += this.Distant ? 2 : 0, a.SetBlock(f, g, i + 16)) : (i = g > i ? 1 : 0, h === e && (i = 1 - i), i += this.Distant ? 2 : 0, a.SetBlock(f, g, i + 8)) }
    }, GenerateUnderground: function (a) {
        var b = 0, c = 0, e = 0, d = 0; if (this.Distant) for (var f =
            0, b = 0; b < this.Width; b++) { Math.random() < 0.75 && (f = 1 - f); for (c = 0; c < this.Height; c++) { e = f; d = c - 2; if (d < 0 || d > 4) d = 2, e = 0; a.SetBlock(b, c, 4 + e + (3 + d) * 8) } } else for (b = 0; b < this.Width; b++)for (c = 0; c < this.Height; c++) { e = b % 2; d = c - 1; if (d < 0 || d > 7) d = 7, e = 0; e === 0 && d > 1 && d < 5 && (e = -1, d = 0); a.SetBlock(b, c, 6 + e + d * 8) }
...
}; Mario.BackgroundRenderer = function (a, b, c, e) { this.Level = a; this.Width = b; this.Distance = e; this.TilesY = (c / 32 | 0) + 1; this.Background = Mario.SpriteCuts.GetBackgroundSheet() }; Mario.BackgroundRenderer.prototype = new Enjine.Drawable;
...
Mario.ImprovedNoise.prototype = {
    Shuffle: function () { for (var a = [], b = 0, c = 0, e = 0, b = 0; b < 256; b++)a[b] = b; for (b = 0; b < 256; b++)c = (Math.random() * 255 | 0) + b, e = a[b], a[b] = a[c], a[c] = e, this.P[b + 256] = this.P[b] = a[b] }, PerlinNoise: function (a, b) { for (var c = 0, e = 0, d = 0, c = 0; c < 8; c++)d = 64 / (1 << c), e += this.Noise(a / d, b / d, 128) / (1 << c); return e }, Noise: function (a, b, c) {
...
Mario.Character.prototype.SubMove = function (a, b) {
    for (var c = !1; a > 8;) { if (!this.SubMove(8, 0)) return !1; a -= 8 } for (; a < -8;) { if (!this.SubMove(-8, 0)) return !1; a += 8 } for (; b > 8;) { if (!this.SubMove(0, 8)) return !1; b -= 8 } for (; b < -8;) { if (!this.SubMove(0, -8)) return !1; b += 8 } b > 0 && (this.IsBlocking(this.X + a - this.Width, this.Y + b, a, 0) ? c = !0 : this.IsBlocking(this.X + a + this.Width, this.Y + b, a, 0) ? c = !0 : this.IsBlocking(this.X + a - this.Width, this.Y + b + 1, a, b) ? c = !0 : this.IsBlocking(this.X + a + this.Width, this.Y + b + 1, a, b) && (c = !0)); if (b < 0) if (this.IsBlocking(this.X +
...
}; Mario.LevelRenderer.prototype.DrawExit1 = function (a, b) { for (var c = 0, e = null, c = this.Level.ExitY - 8; c < this.Level.ExitY; c++)e = this.Background[13][c === this.Level.ExitY - 8 ? 4 : 5], a.drawImage(Enjine.Resources.Images.map, e.X, e.Y, e.Width, e.Height, (this.Level.ExitX << 4) - b.X + 16, (c << 4) - b.Y, e.Width, e.Height) };
    ...
    CreateLevel: function (a, b) {
        ...
        b, c) { for (var e = Math.random() * this.TotalOdds | 0, d = 0, f = 0, f = 0; f < this.Odds.length; f++)this.Odds[f] <= e && (d = f); switch (d) { case Mario.Odds.Straight: return this.BuildStraight(a, b, c, !1); case Mario.Odds.HillStraight: return this.BuildHillStraight(a, b, c); case Mario.Odds.Tubes: return this.BuildTubes(a, b, c); case Mario.Odds.Jump: return this.BuildJump(a, b, c); case Mario.Odds.Cannons: return this.BuildCannons(a, b, c) }return 0 }, BuildJump: function (a, b) {
            ...
            var e = (Math.random() * 10 | 0) + 10, d = this.Height - 1 - Math.random() * 4 | 0, f = 0, g = 0, h = d, i = !0, j = 0, k = 0, l = [], m = 0, n = 0; e > c && (e = c); for (f = b; f < b + e; f++)for (g = 0; g < this.Height; g++)g >= d && a.SetBlock(f, g, 145); for (this.AddEnemyLine(a, b + 1, b + e - 1, d - 1); i;)if (h = h - 2 - Math.random() * 3 | 0, h <= 0) i = !1; else if (j = (Math.random() * 5 | 0) + 3, k = (Math.random() * (e - j - 2) | 0) + b + 1, l[k - b] || l[k - b + j] || l[k - b -
                1] || l[k - b + j + 1]) i = !1; else { l[k - b] = !0; l[k - b + j] = !0; this.AddEnemyLine(a, k, k + j, h - 1); (Math.random() * 4 | 0) === 0 && (this.Decorate(a, k - 1, k + j + 1, h), i = !1); for (f = k; f < k + j; f++)for (g = h; g < d; g++)m = 5, n = 9, f === k && (m = 4), f === k + j - 1 && (m = 6), g === h && (n = 8), a.GetBlock(f, g) === 0 ? a.SetBlock(f, g, m + n * 16) : (a.GetBlock(f, g) === 132 && a.SetBlock(f, g, 180), a.GetBlock(f, g) === 134 && a.SetBlock(f, g, 182)) } return e
        ...
        }, BuildStraight: function (a, b, c, e) { var d = (Math.random() * 10 | 0) + 2, f = this.Height - 1 - (Math.random() * 4 | 0), g = 0, h = 0; e && (d = 10 + (Math.random() * 5 | 0)); d > c && (d = c); for (g = b; g < b + d; g++)for (h = 0; h < this.Height; h++)h >= f && a.SetBlock(g, h, 145); e || d > 5 && this.Decorate(a, b, b + d, f); return d }, Decorate: function (a, b, c, e) {
            if (!(e < 1)) {
            ...
            for (var b = [], c = 0, e = 0, d = 0, f = 0, g = 0, c = 0; c < this.Width + 1; c++) {
                b[c] = []; for (e = 0; e < this.Height +
                    1; e++) { g = 0; for (d = c - 1; d < c + 1; d++)for (f = e - 1; f < e + 1; f++)a.GetBlockCapped(d, f) === 145 && g++; b[c][e] = g === 4 }
...
Mario.Enemy.prototype.Move = function () {
    var a = 0, a = 0; this.WingTime++; if (this.DeadTime > 0) { this.DeadTime--; if (this.DeadTime === 0) { this.DeadTime = 1; for (a = 0; a < 8; a++)this.World.AddSprite(new Mario.Sparkle(this.World, (this.X + Math.random() * 16 - 8 | 0) + 4, (this.Y - Math.random() * 8 | 0) + 4, Math.random() * 2 - 1, Math.random() * -1, 0, 1, 5)); this.World.RemoveSprite(this) } this.FlyDeath && (this.X += this.Xa, this.Y += this.Ya, this.Ya *= 0.95, this.Ya += 1) } else {
...
}; Mario.Enemy.prototype.IsBlocking = function (a, b, c, e) { a = a / 16 | 0; b = b / 16 | 0; if (a === this.X / 16 | 0 && b === this.Y / 16 | 0) return !1; return this.World.Level.IsBlocking(a, b, c, e) };
...
Mario.Fireball.prototype.Move = function () {
    var a = 0; if (this.DeadTime > 0) { for (a = 0; a < 8; a++)this.World.AddSprite(new Mario.Sparkle(this.World, (this.X + Math.random() * 8 - 4 | 0) + 4, (this.Y + Math.random() * 8 - 4 | 0) + 2, Math.random() * 2 - 1 * this.Facing, Math.random() * 2 - 1, 0, 1, 5)); this.World.RemoveSprite(this) } else {
...
Mario.Blastzone = function (world, x, y) { this.World = world; this.Image = Enjine.Resources.Images["blastzone"]; this.PicWidth = 144; this.PicHeight = 156; this.X = x * 16; this.Y = y * 16 - 16; this.Xa = 0; this.Ya = -6; this.XPic = 0; this.YPic = 0; }; this.Layer = 1; Mario.Blastzone.prototype = new Mario.NotchSprite();
/**
    Represents a life-giving mushroom.
    Code by Rob Kleffner, 2011
*/

Mario.Chest = function (world, x, y) { this.RunTime = 0; this.GroundInertia = 0.89; this.AirInertia = 0.1; this.OnGround = false; this.Width = 4; this.Height = 24; this.World = world; this.X = x; this.Y = y; this.Image = Enjine.Resources.Images["items"]; this.XPicO = 8; this.YPicO = 15; this.YPic = 0; this.Height = 12; this.Facing = 1; this.PicWidth = this.PicHeight = 16; this.Life = 0; }; Mario.Chest.prototype = new Mario.NotchSprite();
...
Mario.Shell.prototype.Move = function () {
    var a = 0; if (this.Carried) this.World.CheckShellCollide(this); else if (this.DeadTime > 0) { this.DeadTime--; if (this.DeadTime === 0) { this.DeadTime = 1; for (a = 0; a < 8; a++)this.World.AddSprite(new Mario.Sparkle((this.X + Math.random() * 16 - 8 | 0) + 4, (this.Y + Math.random() * 8 | 0) + 4, Math.random() * 2 - 1, Math.random() * -1, 0, 1, 5)); this.World.RemoveSprite(this) } this.X += this.Xa; this.Y += this.Ya; this.Ya *= 0.95; this.Ya += 1 } else {
...
}; Mario.TitleState.prototype.Exit = function () { this.drawManager.Clear(); delete this.drawManager; delete this.camera; delete this.font };
...
}; Mario.LoadingState.prototype.Exit = function () { delete this.Images };
...
}; Mario.MapState.prototype.Exit = function () { delete this.WaterSprite; delete this.DecoSprite; delete this.HelpSprite; delete this.SmallMario; delete this.LargeMario; delete this.FontShadow; delete this.Font };
...
}; Mario.MapState.prototype.FindConnection = function (a, b) { for (var c = 0, e = 0, c = 0; c < a; c++)for (e = 0; e < b; e++)if (this.Level[c][e] === Mario.MapTile.Level && this.Data[c][e] === -1) return this.Connect(c, e, a, b), !0; return !1 };
...
}; Mario.MapState.prototype.LevelWon = function () { var a = this.XMario / 16, b = this.YMario / 16; this.Data[a][b] === -2 ? this.NextWorld() : (this.Data[a][b] = this.Data[a][b] !== -3 ? 0 : -10, this.RenderStatic()) }; Mario.MapState.prototype.GetX = function () { return 160 }; Mario.MapState.prototype.GetY = function () { return 120 };
...
Mario.LevelState.prototype.Draw = function (a) {
    ...
    a.restore(); this.Layer.Draw(a, this.Camera); this.Layer.DrawExit0(a, this.Camera, Mario.MarioCharacter.WinTime === 0); a.save(); a.translate(-this.Camera.X, -this.Camera.Y); for (b = 0; b < this.Sprites.Objects.length; b++)this.Sprites.Objects[b].Layer === 1 && this.Sprites.Objects[b].Draw(a, this.Camera); a.restore(); this.Layer.DrawExit1(a, this.Camera); this.DrawStringShadow(a, "MARIO " + Mario.MarioCharacter.Lives, 0, 0); this.DrawStringShadow(a, "00000000", 0, 1); this.DrawStringShadow(a, "COIN", 14, 0); this.DrawStringShadow(a, " " +
        ...
        } if (Mario.MarioCharacter.DeathTime > 0) { b = Mario.MarioCharacter.DeathTime + this.Delta; b = b * b * 0.1; if (b > 900 && (Mario.MarioCharacter.Lives--, this.GotoMapState = !0, Mario.MarioCharacter.Lives <= 0)) this.GotoLoseState = !0; this.RenderBlackout(a, Mario.MarioCharacter.XDeathPos - this.Camera.X | 0, Mario.MarioCharacter.YDeathPos - this.Camera.Y | 0, 320 - b | 0) }
};
...
}; Mario.LevelState.prototype.AddSprite = function (a) { this.Sprites.Add(a) }; Mario.LevelState.prototype.RemoveSprite = function (a) { this.Sprites.Remove(a) };
