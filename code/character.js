...
Wario.Character.prototype = new Mario.NotchSprite(null);

Wario.Character.prototype.Initialize = function (world) {
    this.World = world;
    this.X = 32;
    this.Y = 0;
    this.PowerUpTime = 0;
...
Wario.Character.prototype.SetLarge = function (large, fire) {
    if (fire) {
        large = true;
    }
    if (!large) {
...
Wario.Character.prototype.Blink = function (on) {
    this.Large = on ? this.NewLarge : this.LastLarge;
    this.Fire = on ? this.NewFire : this.LastFire;
...
Wario.Character.prototype.Move = function () {
    if (this.WinTime > 0) {
        this.WinTime++;
        this.Xa = 0;
        this.Ya = 0;
...
Wario.Character.prototype.CalcPic = function () {
    var runFrame = 0, i = 0;
...
Wario.Character.prototype.SubMove = function (xa, ya) {
    var collide = false;
...
Wario.Character.prototype.IsBlocking = function (x, y, xa, ya) {
    var blocking = false, block = 0, xx = 0, yy = 0;
...
Wario.Character.prototype.Stomp = function (object) {
    var targetY = 0;
...
Wario.Character.prototype.GetHurt = function () {
    if (this.DeathTime > 0 || this.World.Paused) {
        return;
    }
    if (this.InvulnerableTime > 0) {
...
Wario.Character.prototype.Win = function () {
    this.XDeathPos = this.X | 0;
    this.YDeathPos = this.Y | 0;
    this.World.Paused = true;
    this.WinTime = 1;
...
Wario.Character.prototype.Die = function () {
    this.XDeathPos = this.X | 0;
    this.YDeathPos = this.Y | 0;
    this.World.Paused = true;
    this.DeathTime = 1;
...
Wario.Character.prototype.GetFlower = function () {
    if (this.DeathTime > 0 && this.World.Paused) {
        return;
    }
...
Wario.Character.prototype.GetMushroom = function () {
    if (this.DeathTime > 0 && this.World.Paused) {
        return;
    }
...
Wario.Character.prototype.Kick = function (shell) {
    if (this.DeathTime > 0 && this.World.Paused) {
        return;
    }
...
Wario.Character.prototype.Get1Up = function () {
    Enjine.Resources.PlaySound("1up");
    this.Lives++;
    if (this.Lives === 99) {
        this.Lives = 99;
...
Wario.Character.prototype.GetCoin = function () {
    this.Coins++;
    if (this.Coins === 100) {
        this.Coins = 0;
        this.Get1Up();
